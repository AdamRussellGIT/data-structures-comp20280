...
class UnsortedTableMapTest {
    ...
    void testToString() {
        UnsortedTableMap<Integer, String> map = new UnsortedTableMap<>();
        //java.util.UnsortedTableMap<Integer, String> map = new java.util.UnsortedTableMap<>();
        Integer[] arr = new Integer[] {35,26,15,24,33,4,12,1,23,21,2,5};

        for(Integer i : arr) {
            map.put(i, Integer.toString(i));
        }
        assertEquals("[<35, 35>, <26, 26>, <15, 15>, <24, 24>, <33, 33>, <4, 4>, <12, 12>, <1, 1>, <23, 23>, <21, 21>, <2, 2>, <5, 5>]", map.toString());
    }
